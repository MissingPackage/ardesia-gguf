...
# torch-ggml-ops or running its tests. See memory pathb-build-toolchain.
#
...
set -u
# Sourced under bash or zsh; BASH_SOURCE isn't portable, so allow an override and
# default to the known repo root (single-machine build helper).
_repo="${ARDESIA_GGUF_ROOT:-/home/neuromancer/Projects/ardesia-gguf}"
